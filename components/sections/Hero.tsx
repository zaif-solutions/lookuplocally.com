        ...
        <div className="absolute inset-0 z-10 flex flex-col justify-end">
          ...
          >
            <div className="min-w-0 max-w-3xl">
              <p className="inline-flex max-w-full items-center gap-2 rounded-md border border-white/25 bg-white/5 px-3 py-1.5 text-[0.65rem] font-semibold uppercase tracking-[0.08em] text-white/90 backdrop-blur-sm sm:text-xs">
              ...
              <Button
                asChild
                className="mt-3 w-full gap-2 px-6 py-3 text-base font-semibold shadow-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white sm:w-auto cursor-pointer"
              >
                <Link href="/search">
                  Go to search
